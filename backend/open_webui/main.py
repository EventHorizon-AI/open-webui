            ...
            **(
                {
                    ...
                    'context_compaction_token_threshold': config.get('chat.context_compaction.token_threshold'),
                    'context_compaction_token_cap': config.get('chat.context_compaction.token_cap'),
