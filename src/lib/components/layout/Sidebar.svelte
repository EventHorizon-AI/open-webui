...
{#if $showSidebar}
	...
	>
		<div
			class=" my-auto flex flex-col justify-between h-screen max-h-[100dvh] w-[245px] overflow-x-hidden scrollbar-hidden z-50 border-e border-gray-50 dark:border-gray-850/30 {$showSidebar
				? ''
				: 'invisible'}"
		>
			<div
