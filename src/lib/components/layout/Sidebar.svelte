...
>
	...
	{#if visible || !$mobile}
        ...
        "
			style={$mobile
				? panelStyle
				: `width: ${$showSidebar ? '245px' : '0'}; transition: width 250ms cubic-bezier(0.22, 1, 0.36, 1);`}
			data-state={$showSidebar}
		>
			<div
				class=" my-auto flex flex-col justify-between h-screen max-h-[100dvh] w-[245px] overflow-x-hidden scrollbar-hidden z-50 border-e border-gray-50 dark:border-gray-850/30"
			>
				<div
